...
* Поддержка композитных устройств (например когда одно устройство реализует две ноды)
...
- Возможно будет произведен отказ от уникальных прописываемых UID в пользу хешей как в UAVCAN
